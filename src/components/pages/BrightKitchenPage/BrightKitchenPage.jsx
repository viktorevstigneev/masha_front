...
import i1 from '../../../img/ki1.png';
import i2 from '../../../img/ki2.png';
			...
			<main className="house">
				<div className="house__top">
					<div className="house__content">
						<h1 className="house__title">Bright kitchen</h1>
					</div>
				</div>
				<div className="house__bottom">
					<div className="house__bottom-wrapper">
						<p className="house__bottom-caption">Bright provincial kitchen</p>
